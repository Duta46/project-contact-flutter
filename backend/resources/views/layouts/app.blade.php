...
<head>
    ...
    <!-- Styles -->
    {{-- @livewireStyles --}}
    <link rel="shortcut icon" href="{{ isset($setting->favicon) ? asset('storage/' . $setting->favicon) : asset('assets/images/logo-application.jpg') }}" />
...
<body data-kt-name="監査報告書管理システム" id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true"
